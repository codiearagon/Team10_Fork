...
[CreateAssetMenu(fileName = "PlayerDMGBuff", menuName = "Scriptable Objects/Perks/PlayerDMGBuff")]
public class PlayerDMGBuff : PerkEffect
{
    public float amount;
    ...
    public override void Apply(GameObject player)
    {
        ...
        playerPV.RPC("SetPlayerDMGMulBy", RpcTarget.All, amount);
    }
    ...
    public override IEnumerator Duration(GameObject player, GameObject perkTextInstance)
    {
        ...
        PhotonView playerPV = player.GetComponent<PhotonView>();
        playerPV.RPC("SetPlayerDMGMulBy", RpcTarget.All, 1f);
